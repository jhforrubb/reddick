...
const UserSelect = () => {
    ...
    return (
        <Box as={Menu} size="sm" onOpen={() => setIsMenuOpen(true)} onClose={() => setIsMenuOpen(false)}>
            <Box as={MenuButton} _hover={{ borderWidth: "1px" }} marginLeft="1px" borderWidth={isMenuOpen ? "1px" : "0px"} borderStyle="solid" borderColor="grey" borderRadius="5px">
                <Flex>
            ...
            <MenuList>
                ...
                <MenuGroup title='© 2022 Reddit, Inc. All rights reserved' fontSize="12px" fontWeight={400} lineHeight="16px" textAlign="start" color="#878A8C" />
            </MenuList>
        </Box>
    )
}
